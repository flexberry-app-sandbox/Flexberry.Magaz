...
namespace IIS.Magaz
{
    ...
    public class Заказы : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Magaz.ТипОплаты fТипОплаты;
        
        private IIS.Magaz.ТипПолучения fТипВручения;
        ...
        private IIS.Magaz.Адрес fАдрес;
        
        private IIS.Magaz.Клиенты fКлиенты;
        
        private IIS.Magaz.Сотрудник fСотрудник;
        
        private IIS.Magaz.DetailArrayOfЗаказСланцев fЗаказСланцев;
        
        private IIS.Magaz.DetailArrayOfЗаказТапочек fЗаказТапочек;
        ...
        public virtual IIS.Magaz.ТипПолучения ТипВручения
        {
            get
            {
                ...
                IIS.Magaz.ТипПолучения result = this.fТипВручения;
        ...
        public virtual IIS.Magaz.ТипОплаты ТипОплаты
        {
            get
            {
                ...
                IIS.Magaz.ТипОплаты result = this.fТипОплаты;
        ...
        [PropertyStorage(new string[] {
                "Адрес"})]
        [NotNull()]
        public virtual IIS.Magaz.Адрес Адрес
        {
            get
            {
                ...
                IIS.Magaz.Адрес result = this.fАдрес;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Magaz.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Magaz.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Magaz.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Magaz.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.Magaz.DetailArrayOfЗаказСланцев ЗаказСланцев
        {
            get
            {
                ...
                {
                    this.fЗаказСланцев = new IIS.Magaz.DetailArrayOfЗаказСланцев(this);
                }
                IIS.Magaz.DetailArrayOfЗаказСланцев result = this.fЗаказСланцев;
        ...
        public virtual IIS.Magaz.DetailArrayOfЗаказТапочек ЗаказТапочек
        {
            get
            {
                ...
                {
                    this.fЗаказТапочек = new IIS.Magaz.DetailArrayOfЗаказТапочек(this);
                }
                IIS.Magaz.DetailArrayOfЗаказТапочек result = this.fЗаказТапочек;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказыE", typeof(IIS.Magaz.Заказы));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказыL", typeof(IIS.Magaz.Заказы));
                }
            }
        }
    }
